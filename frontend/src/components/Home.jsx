  ...
  return (
    <div className="edu-sparkle">
            ...
            <Col md={10}>
              <div className="hero-content">
                ...
                <Button variant="primary" size="lg" className="ms-3">
                  <Link to="auth/register">سجّل الآن</Link>
                </Button>
      ...
      <section className="cta-section py-5">
        <Container>
          <div className="cta-container text-center p-5 rounded-4">
            <h2 className="section-title text-white mb-4">
              ابدأ رحلتك التعليمية المتميزة مع إديوسباركل
            </h2>
            <p className="cta-text mb-4">
              انضم إلى الآلاف من المؤسسات التعليمية التي تستفيد من منصتنا
              المتكاملة
            </p>
